...
func (r *repository) CreateSessionExercise(ctx context.Context, se Exercise) (int64, error) {
...
func (r *repository) CreateSet(ctx context.Context, excSet ExerciseSet) (int64, error) {
